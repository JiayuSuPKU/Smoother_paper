...
knitr::opts_knit$set(root.dir = "~/SpatialDeconv/scripts/if_analysis/cleaned_scripts/plot_paper_figure")
library(jpeg)
library(ggplot2)
library(ggpubr)
library(cowplot)
...
data_dir <- "/Users/jysumac/Projects/SpatialDeconv/scripts/if_analysis/cleaned_scripts/plot_paper_figures/"
res_dir <- "/Users/jysumac/Projects/SpatialDeconv/results/if_analysis/deconv_results/"
...
df_nnls <- read.csv(
  paste0(data_dir, "nnls_tcell_cd3_results.csv")
) %>%
  calc_tpr_fpr()
df_card <- read.csv(
  paste0(data_dir, "card_tcell_cd3_results.csv")
) %>%
  calc_tpr_fpr()
...
ggsave("nnls_cd3_plot.pdf", width = 42, height = 18, units = "cm")
ggsave("nnls_cd3_plot.png", width = 42, height = 18, units = "cm")
```
...
ggsave(
  "/Users/jysumac/Projects/SpatialDeconv/results/figures/if/tumor_infiltration.pdf", 
  width = 20, height = 20, units = "cm"
)
ggsave(
  "/Users/jysumac/Projects/SpatialDeconv/results/figures/if/tumor_infiltration.png", 
  width = 20, height = 20, units = "cm"
)
```