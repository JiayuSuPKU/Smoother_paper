...
meta.data.spatial <- meta.data[paste('ME11_H3K27ac#', row.names(image@coordinates), '-1', sep=""), ]
...
saveArchRProject(ArchRProj = proj_in_tissue, outputDirectory = "ME11_H3K27ac", load = FALSE)
